...
# Jesse AI Installation Script for Ubuntu 22.04
# This script installs Jesse AI and its dependencies in a proper virtual environment
...
apt-get -y update || log_error "Failed to update after adding Python repository"
...
apt-get install -y postgresql-13 postgresql-contrib python3-psycopg2 libpq-dev || log_error "Failed to install PostgreSQL"
...
systemctl is-active --quiet redis-server || log_error "Redis service is not running"
